...
- **price-split-adjusted.csv**: 851264 rows × 7 columns.   
    ...
    <br><br>
    <img src="images/Fig_histogram_stock.png" alt="" width="640">  
...
There are many different ways to explore these interactive plots. Due to time constraints, we focused on subsectors from Information Technology (IT) and Utilities here. The IT sector exhibits a wider spread, while the Utilities has a much tighter distribution, making them a good starting point to assess whether PCA is providing meaningful separation. Additionally, we already used AAPL, INTC, and MSFT as our base models for LSTM, all of which belong to the IT sector. Later, we also used PCA-reduce UMAP as an additional evaluation tool to further assess the findings from PCA. 

<br><br>
<img src="images/PCA_sectors.png" alt="" width="640">  
**Fig. PCA Analysis by Selected Sector – Faceted View**. For the complete plot, see [here](https://nysx-interactive-f35996.netlify.app/test10/pca_by_sector_test10)

<br><br>
<img src="images/UMAP_sectors.png" alt="" width="640">  
**Fig. UMAP Analysis by Selected Sector – Faceted View**. For the complete plot, see [here](https://nysx-interactive-f35996.netlify.app/test10/umap_by_sectors_pca_faceted_reduced(n=20)_test10)

<br>

👉 For more details on the analysis, see experiments [test 10](/experiments/NYSX_test10_sectors_PCA_UMAP.ipynb), [test 11](/experiments/NYSX_test11_subsector_tech_PCA.ipynb), and [test 14](/experiments/NYSX_test14_subsector_utils_PCA.ipynb). 
